...
def escutar_reservas():
    ...
    def callback(ch, method, properties, body):
        ...
        if method.routing_key == 'reserva-criada':
            ...
            print(f"cruzeiro_id na reserva: {reserva['cruzeiro_id']}, tipo: {type(reserva['cruzeiro_id'])}")
            print(f"[MS Itinerarios] Cancelando reserva com ID {reserva_id}.")
            alterar_quantidade_cabines(cruzeiro_id=reserva_dict['cruzeiro_id'], num_cabines=reserva_dict['quantidade_cabines'], motivo=TipoReserva.CANCELAMENTO.value)
